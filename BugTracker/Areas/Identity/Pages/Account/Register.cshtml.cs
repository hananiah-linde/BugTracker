...
namespace BugTracker.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserStore<BugTrackerUser> _userStore;
        private readonly IUserEmailStore<BugTrackerUser> _emailStore;
        private readonly ILogger<RegisterModel> _logger;
        private readonly IEmailSender _emailSender;

        public RegisterModel(
            UserManager<BugTrackerUser> userManager,
            IUserStore<BugTrackerUser> userStore,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                BugTrackerUser user = CreateUser();
